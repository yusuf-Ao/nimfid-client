...
const UserUpdateOrganizationModal = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (!formData.menSavings || !formData.womenSavings || !formData.physicallyDisabledSavings || !formData.youthSavings || !formData.totalSavings || !formData.website || !formData.affiliationNumber || !formData.affiliationCategory) {
            return toast.error('All fields are required')
        }
        dispatch(updateOrganization({ formData, toast, modals, setModals }))
    }
        ...
        <div className="fixed grid h-screen z-10 bg-[#11111180] place-items-center w-full">
            <div className="bg-white px-[30px] py-[20px]">
                <ModalHeader
                    ...
                    modalHandler={() => setModals({ ...modals, showUserUpdateOrganizationModal: !modals.showUserUpdateOrganizationModal })}
                />
                            ...
                            <div className="space-y-2 w-[350px]">
                                ...
                                <div className="mb-2">
                                    ...
                                    <select
                                        ...
                                        className="border border-gray-300 text-gray-900 text-lg rounded-lg focus:outline-none focus:ring-teal-500 focus:border-teal-600 block pl-5 px-4 py-1 outline-none w-full"
                                    >
                                        <option value="">---</option>
                            ...
                            <div className="space-y-2 w-[350px]">
                                <div className="mb-2">
                                    ...
                                    <select
                                        ...
                                        className="border border-gray-300 text-gray-900 text-lg rounded-lg focus:outline-none focus:ring-teal-500 focus:border-teal-600 block pl-5 px-2.5 py-1 outline-none w-full"
                                    >
                                        <option value="">---</option>
                                        {states?.map(state => (
                                            <option
...
export default UserUpdateOrganizationModal