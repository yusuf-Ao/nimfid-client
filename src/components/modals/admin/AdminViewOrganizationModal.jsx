...
const AdminViewOrganizationModal = () => {
        ...
        <div className="fixed grid h-screen z-10 bg-[#11111180] place-items-center w-full">
            <div className="bg-white px-[30px] py-[20px]">
                <ModalHeader
                    ...
                    modalHandler={() => setModals({ ...modals, showAdminViewOrganizationModal: !modals.showAdminViewOrganizationModal })}
                />
...
export default AdminViewOrganizationModal