...
import { verifyUserAccount } from '../../state/actions/auth.actions'
...
const VerifyAccount = () => {
    ...
    const handleSubmit = (e) => {
        ...
        dispatch(verifyUserAccount({ formData, toast, navigate }))
    }
    ...
    return (
        <div>
            ...
            <div className='flex flex-col justify-between items-center h-screen bg-primary md:flex-row md:w-full font-poppins bg-background'>
                <div className="border border-slate-400 p-8 w-[400px] mx-auto my-10 bg-white">

                    <div className="my-10">
                        <h1 className="text-[20px] font-medium">Verify Account</h1>
                    </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mb-6">
                            ...
                            <input
                                ...
                                className="border border-gray-300 text-gray-900 text-lg focus:outline-none focus:ring-teal-500 focus:border-teal-600 block w-full pl-5 px-2.5 py-2"
                            />
                        </div>
                        <div className="mb-6">
                        ...
                        <div className="mt-5 flex items-center justify-center text-sm">
                            ...
                            <Link
                                to={'/resend-code'}
                                onClick={() => localStorage.setItem('nimfd-prev-link', '/verify-account')}
