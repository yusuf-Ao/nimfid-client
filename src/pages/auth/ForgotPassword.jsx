...
import { requestForgotPasswordOTP } from '../../state/actions/auth.actions'
...
const ForgotPassword = () => {
    ...
    const handleSubmit = (e) => {
        ...
        dispatch(requestForgotPasswordOTP({ formData, toast, navigate }))
    }
        ...
        <div>
            ...
            <div className='flex flex-col justify-between items-center h-screen bg-background md:flex-row md:w-full font-poppins'>
                <div className="border border-slate-400 p-8 w-[400px] mx-auto my-10 bg-white">
                    ...
                    <div className="my-10">
                        <h1 className="text-[20px] font-medium">Forgot Password</h1>
                    </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mb-6">
                            ...
                            <input
                                ...
                                className="border border-gray-300 text-gray-900 text-lg rounded focus:outline-none focus:ring-sky-500 focus:border-sky-600 block w-full pl-5 px-2.5 py-4"
                            />
                        </div>
