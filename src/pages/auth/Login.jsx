...
const Login = () => {
	...
	return (
		<div>
			...
			<div className='flex flex-col justify-center items-center my-auto h-screen bg-background md:flex-row md:w-full font-poppins'>
				...
				<div className=" border border-slate-400 mx-5 px-8 md:w-[35%] bg-white">
					<div className="my-10">
					...
					<form onSubmit={handleSubmit}>
						...
						<div className="mt-5 flex items-center justify-center pb-2 text-sm">
							Don't have an account?
							<Link to={'/signup'} className="text-sky-500">&nbsp;Register here</Link>
						</div>
					</form>
