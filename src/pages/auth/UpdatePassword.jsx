...
import { updatePassword } from '../../state/actions/auth.actions'
...
const UpdatePassword = () => {
    ...
    const [config, setConfig] = useState({ showPassword: false, showConfirmPassword: false })
    ...
    const handleSubmit = (e) => {
        ...
        // console.log(data)
        dispatch(updatePassword({ formData: { ...data }, toast, navigate }))
    }
        ...
        <div>
            ...
            <div className='flex flex-col justify-between items-center h-screen bg-background md:flex-row md:w-full font-poppins'>
                <div className="border border-slate-400 p-8 w-[400px] mx-auto my-10 bg-white">
                    ...
                    <div className="my-10">
                        <h1 className="text-[20px] font-medium">Update Password</h1>
                    </div>

                    <form onSubmit={handleSubmit}>
                        <div className="mb-2">
                            <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900">OTP</label>
                            <input
                                type="text"
                                name="otp"
                                onChange={handleChange}
                                className="border border-gray-300 text-gray-900 text-lg rounded focus:outline-none focus:ring-sky-500 focus:border-sky-600 block w-full pl-5 px-2.5 py-2"
                            />
                        </div>
                        ...
                        <div className="relative mb-8">
                            ...
                            />
                            <FaEye
                                className={`absolute right-4 bottom-4 cursor-pointer ${config.showPassword ? 'text-teal-600' : 'text-gray-800'}`}
