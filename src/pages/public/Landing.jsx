...
const Landing = () => {
  return (
    <div className='font-poppins'>
      <div class='bg-white h-[10vh]'>
        <nav class='flex justify-between py-3 px-[80px]'>
          <Link class='text-slate-800 font-bold cursor-pointer' to={'/'}>
            <img src={NiMFID} alt='NiMFID' className='' />
          </Link>
          ...
          <ul class='flex items-center space-x-9'>
            ...
            <Link
              to={'/signup'}
              className='flex bg-white border-2 border-primary-1 p-2 gap-2 rounded-sm'
            >
              <svg
                xmlns='http://www.w3.org/2000/svg'
                fill='none'
      ...
      <div className='space-y-10 h-[90vh]'>
        <div className='flex flex-wrap justify-between items-center mx-8 md:pl-[80px] md:ml-0 mt-8'>
          <div className='flex flex-col space-y-10 md:w-[35%]'>
            <h1 className='text-[30px] md:text-[40px] text-primary-2 font-bold'>
              Nigeria Microfinance Institution Directory
            </h1>
            ...
            <Link to={'/public-search'} className='w-fit p-0'>
              ...
              >
                <div class='flex  inset-y-0 left-0 items-center pl-2 pointer-events-none'>
                  ...
                  <a className='ml-4 text-gray-500 font-medium'>
                    Public Search Area
                  </a>

                  <svg
                    class='inline ml-10 mr-4 w-6 h-6 text-gray-300 animate-spin fill-blue-800'
                    viewBox='0 0 100 101'
                    fill='none'
                    xmlns='http://www.w3.org/2000/svg'
                  >
          ...
          <div className='md:block md:w-[60%] h-[80%]'>
            <img src={LandingHeader} alt='' className='w-full h-full' />
          </div>
        </div>
      </div>
    </div>
